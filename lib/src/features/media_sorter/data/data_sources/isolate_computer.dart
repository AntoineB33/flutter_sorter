...
/// This class lives entirely inside the Background Isolate.
/// You can use instance variables here freely because it is created 
/// inside the isolate's memory space.
class _AnalysisWorker {
  ...
  _AnalysisWorker(this.dataPackage, this.columnTypes);
